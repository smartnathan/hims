    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 white-box">
                <div class="card">
                    <h2 class="card-header">Items</h2><hr />
                    <div class="card-body">
                        <a href="{{ url('/admin/items/create') }}" class="btn btn-success btn-sm" title="Add New Item">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/items', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Item Category Id</th><th>Item Brand Id</th><th>Item Group Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->item_category_id }}</td><td>{{ $item->item_brand_id }}</td><td>{{ $item->item_group_id }}</td>
                                        <td>
