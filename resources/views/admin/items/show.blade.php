                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Item Category Id </th><td> {{ $item->item_category_id }} </td></tr><tr><th> Item Brand Id </th><td> {{ $item->item_brand_id }} </td></tr><tr><th> Item Group Id </th><td> {{ $item->item_group_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
