    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="white-box printableArea">
                <h3><b>RECEIPT</b> <span class="label label-success" style="font-weight: bold">Paid</span> <span class="pull-right">#5669626</span></h3>
                <hr>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="pull-right text-right">
                            <address>
                                ...
                                <p class="m-t-30"><b>Receipt Date :</b> <i class="fa fa-calendar"></i> 23rd Jan 2017
                                    {{ date('d F Y', time())}}
