    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 white-box">
                <div class="card">
<h3 class="box-title m-b-0">Edit Service order #{{ $serviceorder->id }}</h3>
                    <div class="card-body">
                        ...
                        {!! Form::model($serviceorder, [
                            'method' => 'PATCH',
                            'url' => ['/admin/serviceorders', $serviceorder->id],
                            'class' => 'form-horizontal',
                            'files' => true
                        ]) !!}

                        @include ('admin.serviceorders.form', ['submitButtonText' => 'Update'])
