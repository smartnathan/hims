<div class="form-group {{ $errors->has('item_brand_manufacturer_id') ? 'has-error' : ''}}">
    {!! Form::label('item_brand_manufacturer_id', 'Item Brand Manufacturer', ['class' => 'col-md-4 control-label']) !!}

    <div class="col-md-6">
        {!! Form::select('item_brand_manufacturer_id', $itembrandmanufacturers, null, ['class' => 'form-control']) !!}
