    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 white-box">
                <div class="card">
<h3 class="box-title m-b-0">Service {{ $service->id }}</h3>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $service->name }} </td></tr><tr><th> Description </th><td> {{ $service->description }} </td></tr><tr><th> Price </th><td> {{ $service->price }} </td></tr>
                                </tbody>
                            </table>
                        </div>
